...
import CandidateAllOtherJobsCards from '../../Components/CandidatePagesComponents/CandidateAllOtherJobsCards';
...
const AllOtherJobs = () => {
  ...
  return (
    <div className='bg-white  '>
      <CandidateNav/>
      <CandidateAllOtherJobsCards />
      <CandidateFooter/>
    </div>
  )
}

export default AllOtherJobs;
