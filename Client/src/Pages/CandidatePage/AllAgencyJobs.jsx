...
import CandidateAllAgencyJobsCards from '../../Components/CandidatePagesComponents/CandidateAllAgencyJobsCards';
...
const AllAgencyJobs = () => {
  ...
  return (
    <div className='bg-white mx-5'>
      <CandidateNav/>
      <CandidateAllAgencyJobsCards />
      <CandidateFooter/>
    </div>
  )
}

export default AllAgencyJobs;
