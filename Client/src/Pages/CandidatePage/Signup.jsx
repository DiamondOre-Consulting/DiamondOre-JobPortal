...
const Signup = ({ toggleForm }) => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/send-otp", {
        email
      })
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/signup",
        {
          name,
          email,
          password,
