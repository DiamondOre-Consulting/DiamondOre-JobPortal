...
const JobsData = () => {
  return (
    <div className='ml-20'>
      <h1 className='px-4 md:px-8 text-teal-500 text-[3em] text-left' >Welcome here</h1>

      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="mb-10 md:mb-16">
                <h2 className="mb-4 text-left text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">New Entries</h2>
            </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="mb-10 md:mb-16">
                <h2 className="mb-4 text-left text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Our competitive advantage</h2>
            </div>
