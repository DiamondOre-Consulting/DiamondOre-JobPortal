    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg">
        ...
        <form
          ...
          className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 bg-gray-50 shadow-gray-300"
        >
          {loading && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                className="w-full bg-white rounded-lg border-1 p-4 pe-12 text-sm shadow-sm"
                type="email"
                placeholder="Email"
                value={email}
