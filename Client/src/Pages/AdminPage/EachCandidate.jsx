...
const EachCandidate = () => {
    ...
    const fetchCandidate = async () => {
      try {
        ...
        const response = await axios.get(
          `https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/all-candidates/${id}`,
          {
            headers: {
  ...
  useEffect(() => {
    const fetchCandidateAppliedJobs = async () => {
        try {
            const response = await axios.get(`https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/all-applied-jobs/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
