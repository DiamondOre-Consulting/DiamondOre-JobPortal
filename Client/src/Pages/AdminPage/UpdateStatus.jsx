...
const UpdateStatus = () => {
    ...
    const fetchStatus = async () => {
      try {
        const response = await axios.get(
          `api.diamondore.in/api/admin-confi/get-status/${id1}/${id2}`,
          {
            headers: {
  ...
  useEffect(() => {
    const fetchCandidatenDetail = async () => {
      try {
        const response = await axios.get(
          `api.diamondore.in/api/admin-confi/all-candidates/${id1}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const updateCvShortlisted = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-cv-shortlisted/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateScreening = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-screening/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateInterviewedScheduled = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-interviewscheduled/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateInterviewed = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-interviewed/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateShortlisted = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-shortlisted/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateJoined = async () => {
    try {
      ...
      const response = await axios.put(
        `api.diamondore.in/api/admin-confi/update-joined/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
