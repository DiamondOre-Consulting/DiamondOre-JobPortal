...
const UpdateStatus = () => {
  ...
  const updateCvShortlisted = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-cv-shortlisted/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateScreening = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-screening/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateInterviewedScheduled = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-interviewscheduled/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateInterviewed = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-interviewed/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateShortlisted = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-shortlisted/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateJoined = async () => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/admin-confi/update-joined/${id1}/${id2}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
