                        ...
                        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 mb-10'>
                            {employees.map((emp) => (
                                <Link to={`/admin-dashboard/employee/${emp?._id}`}
                                    className="bg-white flex justify-between  relative shadow-xl overflow-hidden hover:shadow-2xl cursor-pointer group rounded-xl p-5 transition-all duration-500 transform"
                                    key={emp._id}
                                >
                                    <div className='flex'>
                                        ...
                                        <div className="flex ml-4 items-center gap-4">
                                            <div className="w-fit transition-all transform duration-500">
                                                ...
                                                <p className="text-xs text-gray-500  transform transition-all delay-300 duration-500">
                                                    Email: {emp?.email}
                                                </p>
                                                <p className="text-xs text-gray-500  transform transition-all delay-300 duration-500">
                                                    DOJ: {emp?.doj}
