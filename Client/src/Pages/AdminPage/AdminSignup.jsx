...
const AdminSignup = ({ toggleForm }) => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/send-otp", {
        email
      })
  ...
  const handleAdminSignup = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/signup-admin",
        {
          name,
          email,
          password,
