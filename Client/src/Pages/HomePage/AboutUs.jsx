                ...
                <div  className="mx-auto max-w-screen-xl px-4 md:px-8">
                    ...
                    <div  className="grid grid-cols-2 gap-x-4 gap-y-8 md:grid-cols-4 lg:gap-x-8 lg:gap-y-12">
                        ...
                        <div  className="flex flex-col items-center">
                            ...
                            <LazyLoadImage src="https://media.licdn.com/dms/image/C4E03AQEZ_yJc3ebHOA/profile-displayphoto-shrink_800_800/0/1607527021305?e=1712793600&v=beta&t=7yQCc4QFgHkH7bY0EGCIId5I7i7wGqdzA9ONANU3_UA" loading="lazy" effect="blur" alt="Photo by Radu Florin"  className="h-full w-full object-cover object-center" />
                            </div>
