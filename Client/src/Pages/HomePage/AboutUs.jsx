...
const AboutUs = () => {
  ...
  return (
    <div>
      <Navbar />
      <div
        className="h-96 sm:h-44 md:h-96 lg:h-96 bg-cover bg-center overflow-hidden mt-10"
        style={{
      ...
      <div>
        ...
        <div className="container  mx-auto my-10 p-8  justify-between grid grid-cols-1 md:grid-cols-2 gap-8 flex items-center ">
          <div className="bg-blue-950 p-8 text-white hover:bg-white hover:text-black border-blue-950 shadow-2xl shadow-blue-950">
            <p className="mb-4">
              Our Group has a strong legacy of serving our clients as a staffing
              vendor. Our extensive network and database enables us to recruit
              suitable candidates at short notice. We can close all roles across
              all locations in India. Our specialization is working in the BFSI
              space for sales force hiring. However, we can also provide ‘feet
              on street’ profiles to all the industries.
            </p>
          </div>
          ...
          <div className="mb-4 bg-white p-8 text-black hover:bg-blue-950 hover:text-white shadow-2xl cursor-pointer hover:shadow-blue-950">
            <p>
              {" "}
              We benefit from the diversity of India and the languages spoken
              and we have got specialists from all parts of India who help in
              making the searches very accurate and also to get references from
              the local population.
            </p>
            <p>
              {" "}
              We can cater to Sales and Non Sales roles for all sectors because
              we have a rich pool of candidates from across various industies .
              Many of such candidates are mobile and can easily fit into similar
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="mt-4 text-gray-300">
              Unleash the power of our job portal, with key features designed to
              revolutionize your hiring process. Experience advanced candidate
              matching, streamlined application tracking, personalized job
              alerts, and robust employer branding.
            </p>
          </div>

          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 ">
            <a className="block rounded-xl border border-gray-800 shadow-lg bg-white text-black  p-8 shadow-xl transition hover:border-white-500/10 hover:shadow-white-500/10">
              <svg
              ...
              <p className="mt-1 text-sm text-black">
                Display detailed job listings with information such as job
                title, description, requirements, and application instructions.
              </p>
            </a>

            <a className="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-white-500/10 hover:shadow-white-500/10">
              <svg
              ...
              <p className="mt-1 text-sm text-gray-300">
                Simplified Job Search: Enjoy the simplicity of finding your
                ideal job with our easy-to-use search and filtering options.
                Your next career move is just a few clicks away.
              </p>
            </a>

            <a className="block rounded-xl border border-gray-800 shadow-lg p-8 shadow-xl bg-white text-black transition hover:border-white-500/10 hover:shadow-white-500/10">
              <svg
                className="h-6 w-6 text-gray-900"
                fill="none"
                viewBox="0 0 24 24"
              ...
              <p className="mt-1 text-sm  text-black">
                Our platform keeps you in constant touch with HR
                representatives, ensuring you're informed at every step. Receive
                updates, feedback, and communicate seamlessly for a more
                personalized job application experience.
              </p>
            </a>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 ">
            <a className="block rounded-xl border border-gray-800 shadow-lg bg-white text-black  p-8 shadow-xl transition hover:border-white-500/10 hover:shadow-white-500/10">
              ...
              <p className="mt-1 text-sm text-black">
                Tailor your job preferences and let our system work for you. Our
                regular notifications provide curated job recommendations based
                on your profile, making your job search efficient, effective,
                and hassle-free.
              </p>
            </a>
            ...
            <a className="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-white-500/10 hover:shadow-white-500/10">
              ...
              <p className="mt-1 text-sm text-gray-300">
                Unlock the power of swift talent acquisition through our Shorten
                Hiring Process feature, optimizing your hiring procedures for a
                quicker, more effective recruitment process.
              </p>
            </a>
            ...
            <a className="block rounded-xl border border-gray-800 shadow-lg p-8 shadow-xl bg-white text-black transition hover:border-white-500/10 hover:shadow-white-500/10">
              ...
              <p className="mt-1 text-sm  text-black">
                Enhance your hiring process with sophisticated candidate
                screening tools, leveraging advanced algorithms to analyze and
                match candidates with specific skills and qualifications crucial
                for BFS roles.
              </p>
            </a>
          </div>
      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12" id="ourteam">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          <div className="mb-10 md:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold text-blue-950 md:mb-6 lg:text-3xl">
              Meet our Team
            </h2>

            <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
              Our team is the heartbeat of innovation, embodying diversity,
              passion, and expertise. Together, we strive for greatness, turning
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-8 md:grid-cols-4 lg:gap-x-8 lg:gap-y-12">
            <div className="flex flex-col items-center">
              ...
              <div>
                <div className="text-center font-bold text-blue-950 md:text-lg">
                  Utsav Mathur
                </div>

                <div className="flex justify-center">
                  <div className="flex gap-4">
                    <p className="mb-3 text-center text-sm text-blue-950 md:mb-4 md:text-base">
                      Director
                    </p>
                    <a
                      href="https://www.linkedin.com/in/utsav-mathur-38886780/"
                      target="_blank"
                      className="text-blue-900 transition duration-100 hover:text-blue-950 active:text-gray-600"
                    >
                      <svg
                        className="h-5 w-5"
                        width="24"
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <div className="flex gap-4">
                    ...
                    <a
                      href="https://www.linkedin.com/in/rahul-mathur-69017516/"
                      target="_blank"
                      className="text-blue-900 transition duration-100 hover:text-blue-950 active:text-gray-600"
                    >
                      <svg
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <div className="flex gap-4">
                    ...
                    <a
                      href="https://www.linkedin.com/in/neetu-tomar-756ab818?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                      target="_blank"
                      className="text-blue-900 transition duration-100 hover:text-blue-950 active:text-gray-600"
                    >
                      <svg
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <div className="flex gap-4">
                    ...
                    <a
                      href="https://www.linkedin.com/in/sakshi-jha-58861a225/"
                      target="_blank"
                      className="text-blue-900 transition duration-100 hover:text-blue-950 active:text-gray-600"
                    >
                      <svg
