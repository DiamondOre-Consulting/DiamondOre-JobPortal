  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/candidates/post-review`,
        {
          name,
          email,
          reviewFor,
    ...
    const fetchAllReviews = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_BASE_URL}/candidates/all-reviews`
        );
            ...
            >
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="Kotak Life Insurance">
                    Kotak Life Insurance
                  </option>
                  <option value="Agarwal Packers and Movers">
                    Agarwal Packers and Movers
                  </option>
                  <option value="Aditya Birla Capital">
                  ...
                  <option value="Edelweiss Tokio Life">
                ...
                <label className="block text-gray-700 font-bold mb-2">
                  ...
                  <div className="flex mt-2 cursor-pointer">
                    <RatingStars
                      ...
                      emptyIcon={
                        <img src={diamond} className="w-8 ml-2" alt="diamond" />
                      }
                      filledIcon={
                        <img
                          src={bluediamond}
                    ...
                    <div className="bg-white shadow-xl rounded-md overflow-hidden h-full flex flex-col">
                      ...
                      <div className="flex-1 p-6">
                        ...
                        <div className="flex items-center mt-4">
                          {Array.from({ length: review.diamonds }).map(
                            (_, index) => (
                              <img
                                key={index}
                                src={bluediamond}
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    We appreciate your feedback. Your review helps us improve
                    our service.
                  </p>
                </div>
              </div>
