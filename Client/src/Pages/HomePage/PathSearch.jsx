            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-8">
                        ...
                        <div className="flex flex-col xxs:p-4 overflow-hidden rounded-lg  bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                ...
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-8">
                        ...
                        {latestJobs.map((latestJob) => (
                            <div className="flex flex-col overflow-hidden xxs:p-4 rounded-lg bg-blue-900 sm:p-4 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
