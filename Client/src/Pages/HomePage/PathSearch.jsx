            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="mb-10 md:mb-16">
                        <h2 className="mb-4 text-center text-2xl font-bold text-black md:mb-6 lg:text-3xl font-serif"><span className='text-7xl text-blue-950'>4</span>Step Easy Process</h2>
                        ...
                        <div className="flex flex-col overflow-hidden rounded-lg  bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                            ...
                            <div className="flex flex-1 flex-col py-4 sm:p-6">
                                <h2 className="mb-2 text-lg font-semibold text-white">
                                    ...
                                    <div className='w-24 bg-gray-400 h-0.5 hover:w-48 transition-width duration-300'></div>
                                </h2>
            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="mb-10 md:mb-16">
                        ...
                        <p className="mx-auto max-w-screen-md text-center text-black md:text-lg leading-none" style={{ fontFamily: "'Roboto', sans-serif" }}>

                            <span className='text-5xl text-blue-950 leading-none leading-none'>" </span>
                            ...
                            <span className='text-5xl text-blue-950 leading-none'> "</span>
                        </p>
                    </div>
