        ...
        <div>
            <div ref={ref}>
                <motion.div
                    variants={variants}
                    initial="hidden"
                    animate={inView ? "visible" : "hidden"} // Apply animation only when in view
                    transition={{ duration: 0.5 }}
                >
                    <div className="bg-white py-4 sm:py-6 lg:py-8">
                        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                            <div className="mb-10 md:mb-16">
                                <h2 className="mb-4 text-center text-2xl font-bold text-black md:mb-6 lg:text-3xl  sm:p-3"><span className='text-7xl text-blue-950'>4</span> Step Easy Process</h2>

                                <p className="mx-auto max-w-screen-md text-center text-black md:text-lg" style={{}}>Navigate our job portal seamlessly in 4 steps: Explore opportunities, tailor your profile, apply effortlessly, and embark on your career journey with ease.</p>
                            </div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-8">
                                ...
                                <div className="flex flex-col overflow-hidden rounded-lg  bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                                    ...
                                    <div className="flex flex-1 flex-col py-4 px-4 sm:p-6">
                                        <h2 className="mb-2 text-lg font-semibold text-white">
                                            <p className="transition duration-100 text-white ">Register your Account</p>
                                            <div className='w-24 bg-gray-400 h-0.5 hover:w-48 mb-2 transition-width duration-300'></div>
                                        </h2>

                                        <p className="mb-8 text-gray-200 text-sm" style={{}}>Unlock a world of opportunities and seamless access by creating your account today. Join our community and experience the benefits of being part of.</p>
                                ...
                                <div className="flex flex-col overflow-hidden rounded-lg bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                                    ...
                                    <div className="flex flex-1 flex-col p-4 sm:p-6">
                                        <h2 className="mb-2 text-lg font-semibold text-white">
                                            <p className="transition duration-100 text-white ">Search for your Job</p>
                                            <div className='w-24 bg-gray-400 h-0.5 mb-2 hover:w-48 transition-width duration-300'></div>
                                        </h2>

                                        <p className="mb-8 text-gray-200 text-sm" style={{}}>Our platform simplifies the job-hunting process, offering a seamless experience to navigate through diverse roles.Take control of your professional destiny by exploring a wide array of job listings at your fingertips</p>
                                ...
                                <div className="flex flex-col overflow-hidden rounded-lg bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                                    ...
                                    <div className="flex flex-1 flex-col p-4 sm:p-6">
                                        <h2 className="mb-2 text-lg font-semibold text-white">
                                            <p className="transition duration-100 text-white ">Click On Apply Button</p>
                                            <div className='w-24 bg-gray-400 h-0.5 hover:w-48 mb-2 transition-width duration-300'></div>
                                        </h2>

                                        <p className="mb-6 text-gray-200 text-sm" style={{}}>Embark on a journey towards your dream career by submitting your application today. This is your opportunity to showcase your skills and passion, aligning with the vision of your ideal job</p>
                                ...
                                <div className="flex flex-col overflow-hidden rounded-lg bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                                    ...
                                    <div className="flex flex-1 flex-col p-4 sm:p-6">
                                        <h2 className="mb-2 text-lg font-semibold text-white">
                                            <p className="transition duration-100 text-white ">Get your job</p>
                                            <div className='w-24 bg-gray-400 h-0.5 mb-2 hover:w-48 transition-width duration-300'></div>
                                        </h2>

                                        <p className="mb-8 text-gray-200 text-sm" style={{}}>We understand the importance of finding the right career path, and we're here to help you every step of the way. Explore exciting opportunities, unleash your potential, and embark on a fulfilling professional journey.</p>
                    ...
                    <div className="bg-white py-6 sm:py-8 lg:py-12">
                        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                            <div className="mb-10 md:mb-16">
                                ...
                                <p className="mx-auto max-w-screen-md text-center text-black md:text-lg " style={{}}>
                                ...
                                {latestJobs.map((latestJob, index) => (
                                    <div key={index} className="flex flex-col overflow-hidden rounded-lg bg-blue-900 p-4 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
                                        <div className="flex flex-1 flex-col py-4 ">
                                            ...
                                            <div className="mb-2 text-lg font-normal text-gray-200 text-left" style={{}}>Industry:- {latestJob?.Industry}</div>

                                            <div className="mb-2 text-lg font-normal text-gray-200 text-left" style={{}}>Channels:- {latestJob?.Channel}</div>

                                            <div className="mb-2 text-lg font-normal text-gray-200 text-left" style={{}}>Experience:- {latestJob?.MinExperience}</div>
