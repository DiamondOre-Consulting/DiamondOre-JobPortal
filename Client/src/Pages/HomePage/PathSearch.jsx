      ...
      <div className="bg-white py-4 sm:py-6 lg:py-8">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="mb-10 md:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold text-black md:mb-6 lg:text-3xl  sm:p-3">
              <span className="text-7xl text-blue-950">4</span> Step Easy
              Process
            </h2>

            <p
              className="mx-auto max-w-screen-md text-center text-black md:text-lg"
              style={{}}
            >
              Navigate our job portal seamlessly in 4 steps: Explore
              opportunities, tailor your profile, apply effortlessly, and embark
              on your career journey with ease.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-8">
            <div className="flex flex-col overflow-hidden rounded-lg  bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
              <div className=" border-1 bg-white text-black w-10 p-2 text-center rounded-full m-2">
                1
              </div>
              <svg
            ...
            <div className="flex flex-col overflow-hidden rounded-lg bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
              ...
              <div className="flex flex-1 flex-col p-4 sm:p-6">
                ...
                <p className="mb-6 text-gray-200 text-sm" style={{}}>
                  Embark on a journey towards your dream career by submitting
                  your application today. This is your opportunity to showcase
                  your skills and passion, aligning with the vision of your
                  ideal job
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col overflow-hidden rounded-lg bg-blue-900 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900">
              ...
              <div className="flex flex-1 flex-col p-4 sm:p-6">
                ...
                <p className="mb-8 text-gray-200 text-sm" style={{}}>
                  We understand the importance of finding the right career path,
                  and we're here to help you every step of the way. Explore
                  exciting opportunities, unleash your potential, and embark on
                  a fulfilling professional journey.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="mb-10 md:mb-16">
            ...
            <p
              ...
              style={{}}
            >
              Embark on a journey of possibilities and discover your dream
              career with us. Explore exciting job opportunities tailored to
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-8">
            {latestJobs.map((latestJob, index) => (
              <div
                key={index}
                className="flex flex-col overflow-hidden rounded-lg bg-blue-900 p-4 hover:bg-blue-950 shadow-lg shadow-gray-800 hover:shadow-2xl shadow-gray-900"
              >
                <div className="flex flex-1 flex-col py-4 ">
                  <div className="mb-2 text-lg font-bold text-white text-left   ">
                    {latestJob?.JobTitle}
                  </div>

                  <div
                    className="mb-2 text-lg font-normal text-gray-200 text-left"
                    style={{}}
                  >
                    Industry:- {latestJob?.Industry}
                  </div>
                  ...
                  <div
                    ...
                    style={{}}
                  >
                    Experience:- {latestJob?.MinExperience}
                  </div>

                  <Link to={"/all-jobs/:id"}>
                    {" "}
                    <button className="px-4 py-2 bg-blue-950 text-gray-200 rounded-md hover:bg-white hover:text-black ">
                      Know More
                    </button>{" "}
                  </Link>
                </div>
