  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-screen-xl px-6 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            <div className="lg:col-span-2 lg:py-12">
              ...
              <div className="mt-8">
                <a href="" className="text-xl font-bold text-gray-600">
                  +91 7838738916
                </a>
                <br></br>
                <a href="" className="text-xl font-bold text-gray-600">
                ...
                <div className="flex my-3">
                  <Link
                    to={
                      "https://youtube.com/@DiamondOre-Career?si=mqRnjJzO1gzsU0lu"
                    }
                  >
                    {" "}
                    <svg
                      className="h-8 w-8 text-gray-700 mr-3 hover:text-blue-950"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                  ...
                  <Link
                    to={
                      "https://www.facebook.com/people/Diamond-Ore-Consulting-Pvt-Ltd/61555444963500/?mibextid=ZbWKwL"
                    }
                  >
                    <svg
                      className="h-8 w-8 text-gray-700 mr-3 hover:text-blue-950"
                  ...
                  <Link
                    to={
                      "https://www.instagram.com/diamondoreconsultingpvtltd/?igsh=ZG0zeW42Ynk5OTk5"
                    }
                  >
                    <svg
                      className="h-8 w-8 text-gray-700 hover:text-blue-950"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      strokeWidth="2"
            ...
            <div className="rounded-md bg-blue-950 shadow-xl  lg:col-span-3 lg:p-12">
              <form className="space-y-3 p-4">
                ...
                <div className="mt-4 w-full">
                  <button
                    type="submit"
                    className="inline-block w-full flex justify-center items-center   rounded-lg bg-white px-5 py-3 font-medium text-black "
                    onClick={sendmessage}
                  >
                    {loader ? (
                      <div role="status">
                        <svg
                          aria-hidden="true"
                          class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 text-center "
                          viewBox="0 0 100 101"
                          fill="none"
                  ...
                  {sucesss && (
                    <div className="flex items-center justify-center bg-green-700 mt-3 p-4 rounded-md">
                      <p className="text-center text-sm text-3xl text-gray-200">
                        {sucesss}
                      </p>
                    </div>
                  )}
      ...
      <div className="relative  w-full sm:w-full lg:h-full lg:w-full px-8 mb-16">
        <iframe
          className="w-full rounded-md border border-blue-950 border-5"
