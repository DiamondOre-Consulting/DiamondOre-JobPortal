        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="mb-10 md:mb-16">
            ...
            <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
              Empowering success through tailored Management Consulting,
              Financial Guidance and innovative IT Products, we solve for you.
            </p>
          </div>

          <div className="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
            <a
              href="https://www.referbiz.in/"
              target="_blank"
              className="flex divide-x rounded-lg border bg-blue-950 text-white shadow-lg shadow-blue-900"
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-200 text-sm">
                  Unlock your business potential with our focused management
                  consulting. Our proven strategies streamline operations, drive
                  efficiency, and propel your organization towards sustainable
                  growth. Trust our experts to navigate challenges and seize
            ...
            <a
              href="https://www.referbiz.in/"
              target="_blank"
              className="flex divide-x rounded-lg border bg-white text-black shadow-lg"
            >
              <div className="flex items-center p-2 text-indigo-500 md:p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="p-4 md:p-6">
                <h3 className="mb-2 text-lg font-semibold md:text-xl">
                  Financial Advisory Services - The Midas Touch
                </h3>
                <p className="text-gray-800 text-sm">
                  Elevate Your Wealth with Midas Group. Expertly crafted
                  investment strategies tailored to suit your needs. Let Midas
                  guide you towards financial prosperity and peace of mind. Take
                  control of your future with our proven track record of
                  success.
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-200 text-sm">
                  Elevate Your Career with CV-Genie. Our tailored CV Crafting
                  services ensure that your strengths shine, opening doors to
                  new opportunities. Trust us to craft a standout resume that
                  accelerates your professional journey.
                </p>
              </div>
            </a>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-2 mt-4">
            <a
              href="https://www.referbiz.in/"
              target="_blank"
              className="flex divide-x rounded-lg border bg-white shadow-lg "
            >
              <div className="flex items-center p-2 text-indigo-500 md:p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-500">
                  Discover Your Ideal Property Solutions with Our Real Estate
                  Expertise. Whether you're buying, selling, or investing, our
                  customized approach ensures that you navigate the market with
                  confidence. From dream homes to lucrative investments, we turn
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-200">
                  Empower Your Business with Relliable IT Services. We
                  specialize in creating dynamic websites that captivate your
                  audience and drive growth. Our comprehensive approach ensures
                  seamless integration and unparalleled user experiences. Trust
                  DOC-Labz to elevate your online presence and propel your
