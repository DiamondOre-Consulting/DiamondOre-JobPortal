            ...
            <div  className="bg-white py-6 sm:py-8 lg:py-12">
                <div  className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div  className="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
                        ...
                        <div  className="flex divide-x rounded-lg border bg-blue-950 text-white shadow-lg shadow-blue-900">
                        ...
                        <div  className="flex divide-x rounded-lg border bg-white text-black shadow-lg">
                            <div  className="flex items-center p-2 text-indigo-500 md:p-4">
                                <svg xmlns="http://www.w3.org/2000/svg"  className="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                </svg>
                    ...
                    <div className='grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-2 mt-4'>
                        ...
                        <div  className="flex divide-x rounded-lg border bg-white shadow-lg ">
                            <div  className="flex items-center p-2 text-indigo-500 md:p-4">
                                <svg xmlns="http://www.w3.org/2000/svg"  className="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                </svg>
