...
import AllJobs from "./Pages/HomePage/AllJobs";
      ...
      {loading ? (
        ...
        <Router>
          <Routes>
            ...
            <Route path="/all-jobs-page" element={<AllJobs />} />
            ...
            <Route element={<AuthVerify />}>
              ...
              <Route
                path="/admin/all-candidates"
                element={<AdminAllCandidates />}
              />
              <Route
                path="/admin/all-candidates/:id"
                element={<EachCandidate />}
              />
              <Route
                path="/update-status/:id1/:id2"
            ...
            <Route element={<EmpAuthVerify />}>
              ...
              <Route
                path="/employee-performence"
                element={<EmployeePerformence />}
              />
              <Route
                path="/employee-dashboard/*"
                element={<EmpDrawerSidebar />}
              />
            </Route>
            ...
            <Route
              path="/intern-rnrboard/:passcode"
              element={<InternRnrBoard />}
            />
          </Routes>
        </Router>
      )}
