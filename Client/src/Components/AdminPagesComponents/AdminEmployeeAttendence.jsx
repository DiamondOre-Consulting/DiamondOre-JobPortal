        ...
        const fetchAllEmployee = async () => {
            try {
                ...
                const response = await axios.get(
                    "api.diamondore.in/api/admin-confi/all-employees",
                    {
                        headers: {
        ...
        const fetchEmployeeDetails = async () => {
            try {
                ...
                if (selectedEmployee) {
                    ...
                    const response = await axios.get(
                        `api.diamondore.in/api/admin-confi/all-employees/${selectedEmployee._id}`,
                        {
                            headers:
                            {
                                Authorization: `Bearer ${token}`,
        ...
        const fetchEmployeeAndLeaveReport = async () => {
            try {
                ...
                if (selectedEmployee) {
                    ...
                    const response = await axios.get(
                        `api.diamondore.in/api/admin-confi/leave-report/${selectedEmployee._id}`,
                        {
                            headers:
                            {
                                Authorization: `Bearer ${token}`,
        ...
        const fetchEmployeeAndPerformenceReport = async () => {
            try {
                ...
                if (selectedEmployee) {
                    ...
                    const response = await axios.get(
                        `api.diamondore.in/api/admin-confi/performance-report/${selectedEmployee._id}`,
                        {
                            headers:
                            {
                                Authorization: `Bearer ${token}`,
