        ...
        const fetchEmployeeAndPerformenceReport = async () => {
            try {
                ...
                const leaveReportResponse = await axios.get(
                    `https://diamondore-jobportal-backend.onrender.com/api/admin-confi/performance-report/${id}`,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                `https://diamondore-jobportal-backend.onrender.com/api/admin-confi/add-performance-report/${id}`,
                {
                    month,
                    year,
                    multipleOf4x,
