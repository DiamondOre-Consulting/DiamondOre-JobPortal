        ...
        const fetchEmployeeAndLeaveReport = async () => {
            try {
                ...
                const leaveReportResponse = await axios.get(
                    `https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/leave-report/${id}`,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                `https://diamondore-jobportal-backend-zwfh.onrender.com/api/admin-confi/add-leave-report/${id}`,
                {
                    month,
                    year,
                    absentDays,
