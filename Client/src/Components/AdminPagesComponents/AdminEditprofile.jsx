...
const AdminEditprofile = () => {
    ...
    useEffect(() => {
      const fetchUserData = async () => {
        ...
        try {
          const response = await axios.get("api.diamondore.in/api/admin-confi/user-data", {
            headers: {
    ...
    const handleUploadImage = async (e) => {
      try {
        ...
        const response = await axios.post(
          "api.diamondore.in/api/admin-confi/upload-profile-pic",
          formData,
          {
            headers: {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const token = localStorage.getItem("token");
        await axios.put('api.diamondore.in/api/admin-confi/edit-profile', formData, {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'multipart/form-data',
          },
