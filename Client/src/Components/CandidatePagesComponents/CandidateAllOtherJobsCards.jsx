      ...
      const fetchAllOtherJobs = async () => {
        try {
          ...
          const response = await axios.get(
            "http://localhost:5000/api/candidates/all-other-jobs",
            {
                headers: {
      ...
      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        {otherJobs.map((otherJob) => (
              ...
              >
                ...
                <p className="text-xl text-gray-600 font-semibold">Channel - <span className="text-blue-950">{otherJob?.Channel}</span></p>
                <p className="text-xl text-gray-600 font-semibold">
                ...
                <Link to={`/all-jobs/${otherJob?._id}`} class="cursor-pointer w-full flex-col rounded-lg bg-white p-4 text-center hover:bg-blue-950 text-gray-800 hover:text-gray-200">
