      ...
      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        {bancaJobs.map((bancaJob) => (
              ...
              >
                ...
                <p className="text-xl text-gray-600 font-semibold">Channel - <span className="text-blue-950">{bancaJob?.Channel}</span></p>
                <p className="text-xl text-gray-600 font-semibold">
                ...
                <Link to={`/all-jobs/${bancaJob?._id}`} class="cursor-pointer w-full flex-col rounded-lg bg-white p-4 text-center hover:bg-blue-950 text-gray-800 hover:text-gray-200">
