...
const CandidateEditprofile = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get("https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/user-data", {
          headers: {
  ...
  const handleUploadImage = async (e) => {
    try {
      ...
      const response = await axios.post(
        "https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/upload-profile-pic",
        formData,
        {
          headers: {
  ...
  const handleUploadResume = async (e) => {
    try {
      ...
      const response = await axios.post(
        "https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/upload-resume",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const response=await axios.put('https://diamondore-jobportal-backend-zwfh.onrender.com/api/candidates/edit-profile',
       formData,
        {
        headers: {
          Authorization: `Bearer ${token}`,
