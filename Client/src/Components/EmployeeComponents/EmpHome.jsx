...
const EmpHome = ({
  ...
  return (
    <div className="">
      {/* <img src="https://shorturl.at/BSdxf" alt="" className='fixed top-0 left-0 w-full h-full' /> */}
      <div className="relative overflow-x-hidden">
        {showConfetti && <Confetti />}
        <span className="text-4xl font-bold text-gray-700">Welcome,</span>
        <span className="ml-2 text-4xl font-bold text-gray-700">
          {userData?.name}
        </span>
        {userData?.joiningExcel && (
          <a
            className="bg-blue-900 float-right p-3 text-gray-100"
            href={userData?.joiningExcel}
          >
            Download Joinings{" "}
          </a>
        )}
        ...
        {latestnews?.map((newNews, index) => (
          <div
            ...
            className="p-4 mt-8 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50"
            role="alert"
          >
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-medium">
                Breaking News & Annoucement
              </h3>
            </div>
            <div className="mt-2 mb-4 text-sm">{newNews.news}</div>
            {/* <div class="flex">
        ...
        <div className="mt-10 md:mt-20 md:px-6">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
            <div className="">
              <h1 className="px-10 py-2 text-2xl font-semibold text-center text-gray-900 uppercase">
                {" "}
                Top 5 hr
              </h1>
            ...
            <div className="">
              <h1 className="px-10 py-2 text-xl font-semibold text-center text-gray-900 uppercase">
                {" "}
                Top 5 Clients
              </h1>
              <table className="w-full text-sm text-center text-gray-500 border rtl:text-right border-1">
